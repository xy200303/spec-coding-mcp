...
发布前需要在 npmjs.com 的 package Trusted Publisher 中允许这个 GitHub 仓库和 `.github/workflows/publish-npm.yml`。Release tag 必须和 `package.json` 的版本一致，例如当前版本 `0.1.0` 对应 tag `v0.1.0`。
