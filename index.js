...
server.registerTool("docs_code_init", {
...
server.registerTool("docs_code_generate_from_prompt", {
...
}, async ({ projectRoot, docsDir, prompt, projectName, overwrite }) => textResult(await generateSpecsFromPrompt({ projectRoot, docsDir, prompt, projectName, overwrite })));
server.registerTool("docs_code_generate_from_source", {
...
}, async ({ projectRoot, docsDir, projectName, overwrite, includePatterns, excludePatterns, maxFiles }) => textResult(await generateSpecsFromSource({ projectRoot, docsDir, projectName, overwrite, includePatterns, excludePatterns, maxFiles })));
server.registerTool("docs_code_scan", {
...
server.registerTool("docs_code_plan", {
...
server.registerTool("docs_code_context", {
...
}, async ({ projectRoot, docsDir, maxBlocks, maxBlockChars, candidateFileLimit, includeFullText }) => textResult(await createModelContext({ projectRoot, docsDir, maxBlocks, maxBlockChars, candidateFileLimit, includeFullText })));
server.registerTool("docs_code_mark_synced", {
...
server.registerTool("docs_code_reset_state", {
