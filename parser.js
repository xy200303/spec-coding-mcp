...
export function inferKind(titlePath, file) {
...
export function extractKeywords(text, titlePath) {
...
export async function scanDocs(root, docsDir = "docs") {
