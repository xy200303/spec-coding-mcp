...
import { initProject, markProjectSynced, planImplementation, resetState, scanProject } from "./core/project.js";
...
export function createDocsIsCodeServer(): McpServer {
...
export async function serveStdio(): Promise<void> {
  const server = createDocsIsCodeServer();
